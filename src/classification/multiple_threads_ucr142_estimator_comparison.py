...
estimators = {
    MOMENT_QUANT_EXACT: MomentQuantTransformer(depth=DEPTH, div=DIV, mode="exact", exact_version="auto", parallel=True),
    MOMENT_QUANT_APPROX: MomentQuantTransformer(
        depth=DEPTH, div=DIV, mode="approx", approx_version="auto", parallel=True
    ),
...
path = os.path.join("results", "classification", "multiple_threads_ucr142_estimator_comparison")
